...
{
    internal class InstructionText
    {
    ...
    public class ObjectInstructionRenderer : InstructionRenderer
    {
        ...
        private readonly List<InstructionText> texts = new List<InstructionText>();
        ...
        public override bool IsEnabled
        {
            ...
            set
            {
                foreach (var text in texts) text.Renderer.enabled = value;
